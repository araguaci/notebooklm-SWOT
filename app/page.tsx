...
const ShareSection = () => {
  ...
  const shareTitle = "🛰️ SWOT: Da Estratégia Empresarial ao Monitoramento Oceânico Global";
  const shareText = "Explore todos os materiais e artefatos gerados pelo Google NotebookLM sobre Análise SWOT.";
