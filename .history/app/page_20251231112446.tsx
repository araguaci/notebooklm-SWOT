...
const ShareSection = () => {
  ...
  const shareData = {
    title: "🛰️ SWOT: Da Estratégia Empresarial ao Monitoramento Oceânico Global",
    text: "Explore todos os materiais e artefatos gerados pelo Google NotebookLM sobre Análise SWOT.",
    url: currentUrl,
  };
  ...
  const shareLinks = [
    ...
    },
    {
      ...
      href: `https://twitter.com/intent/tweet?text=${encodeURIComponent(shareData.title)}&url=${encodeURIComponent(currentUrl)}`,
    },
    {
      name: "LinkedIn",
      icon: Linkedin,
    ...
    },
    {
      ...
      href: `https://wa.me/?text=${encodeURIComponent(shareData.title + " " + currentUrl)}`,
    },
  ];
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-16">
      ...
      >
        ...
        <p className="text-gray-400 text-lg max-w-2xl mx-auto">
          Ajude outros a descobrirem este recurso sobre Análise SWOT
        </p>
      </motion.div>
